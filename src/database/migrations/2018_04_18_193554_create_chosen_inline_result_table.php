...
class CreateChosenInlineResultTable extends Migration
{
    public function up()
    {
        Schema::create(config('phptelegrambot.database.prefix', '') . 'chosen_inline_result', static function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('phptelegrambot.database.prefix', '') . 'chosen_inline_result');
    }
}
