...
class CreateUserTable extends Migration
{
    public function up()
    {
        Schema::create(config('phptelegrambot.database.prefix', '') . 'user', static function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('phptelegrambot.database.prefix', '') . 'user');
    }
}
